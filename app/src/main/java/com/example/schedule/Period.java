...
import java.util.ArrayList;
    ...
    public class Period {
        ...
        public static void clearPeriods() {
            periods.clear();
        }
        ...
        public static void loadPeriodsB() {
            ...
            periods.add(new Period(new WTime(1, 10, 25), 70, "3"));
            periods.add(new Period(new WTime(1, 11, 45), 25, "Lunch"));
            periods.add(new Period(new WTime(1, 12, 30), 45, "Practicum & Extra help"));
            ...
            periods.add(new Period(new WTime(2, 10, 25), 70, "2"));
            periods.add(new Period(new WTime(2, 11, 45), 25, "Lunch"));
            periods.add(new Period(new WTime(2, 12, 30), 45, "Practicum & Extra help"));
            ...
            periods.add(new Period(new WTime(3, 11, 30), 60, "Cafeteria Lunch"));
            ...
            periods.add(new Period(new WTime(5, 11, 0), 40, "Chapel"));
            periods.add(new Period(new WTime(5, 11, 45), 25, "Lunch"));
            periods.add(new Period(new WTime(5, 12, 30), 45, "Practicum & Extra help"));
            periods.add(new Period(new WTime(5, 13, 20), 45, "7"));
            periods.add(new Period(new WTime(5, 14, 10), 45, "4"));


            periods.add(new Period(new WTime(6, 8, 0), 30, "Flex Block"));
            ...
            periods.add(new Period(new WTime(6, 11, 0), 45, "5"));
            periods.add(new Period(new WTime(6, 11, 45), 40, "Lunch"));
        }
        ...
        public static void setAllPeriodInfo(String num, String meets, String className, String room, String teacher) {
            ...
            System.out.println(periods.get(1).subject);
        }
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawText(getPeriod(), 20 + para * 110, ge - 5, paint);
            paint.setTextAlign(Paint.Align.RIGHT);
            canvas.drawText(end.getHourAMPM() + ":" + end.getMinuteS(), 120 + para * 110, ge - 3, paint);
            paint.setTextAlign(Paint.Align.CENTER);
            canvas.drawText(subject, 75 + para * 110, (ge + gs) / 2 - 20, paint);
            canvas.drawText(room, 75 + para * 110, (ge + gs) / 2 - 40, paint);
            canvas.drawText(teacher, 75 + para * 110, (ge + gs) - 60, paint);
        ...
        //Draw the period in the mainActivity
        public void drawM(Canvas c, Period p) {
            Paint paint = new Paint();
            paint.setStyle(Paint.Style.STROKE);
            paint.setTextSize(20);
            paint.setStrokeWidth(2);
            Rect rectangle = new Rect(450, p.start.ticks / 400, 580, p.end.ticks / 400);
